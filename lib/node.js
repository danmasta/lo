...
import { access, constants as FS_CONSTANTS, readFile } from 'node:fs/promises';
...
import { getType, isArray, isEsmMode, isNil, toNativeType } from './types.js';
import { getOwn, split, toCamel } from './util.js';
