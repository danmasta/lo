...
// Error subtypes (base Error in core)
export const errors = [
    {
        n: 'TypeError',
        x: [1, 1, 2]
...
export const iterators = [
    ...
    },
    {
        ...
        // Note: The constructor doesn't exist, but we can still match via isPrototypeOf
        n: 'AsyncIterator',
        c: undefined,
        p: getPrototypeOf(getPrototypeOf(getPrototypeOf(genFnAsync()))),
        x: [0, 0, 0, 1],
        a: 1
    },
    {
...
// Function subtypes (base Function in core)
...
// Modern ECMAScript built-ins present in most runtimes
// Note: Excludes error subtypes (which are opt-in)
const builtins = [
    ...collections,
    ...binary,
    ...iterators,
...
// Core primitives plus modern built-ins
// Note: Default group
export const base = [
    ...core,
    ...builtins
...
// Modern built-ins, error subtypes, web
