...
import { getType, hasForEach, isAsyncFunction, isAsyncIterable, isFunction, isIterable, notNil, toFn } from './types.js';
...
// Async alias
async function iterateFA (obj, fn=id, col, retFn, res, valFltr, retFltr, type, iter, iterA, fnA) {
...
// Note: Can break iteration early by returning BREAK symbol
function iterateF (obj, fn=id, col, retFn, res, valFltr, retFltr, type, iter) {
...
function composeF (obj, fn, col=1, retFn, res, valFltr, retFltr) {
    ...
    fn = toFn(fn, id);
    if (async) {
        return iterateFA(obj, fn, col, retFn, res, valFltr, retFltr, type, iter, iterA, fnA);
    }
