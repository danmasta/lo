import { addType, getOwnPropertyDescriptor, getPrototypeOf, hasOwn, isPrototypeOf, noop, PRIMITIVES, REGEX, TYPE, TYPES, typesByCtor, typesByProto, typesByType } from './constants.js';
...
export function getTypeFromProto (obj, { recurse=3, of, add=1, ref=obj }={}) {
...
// Will recurse the whole prototype chain if recurse is -1 or Infinity
// Returns TYPES.Unknown if type not found
export function getTypeFromCtor (obj, { recurse=3, of, add=1, ref=obj }={}) {
