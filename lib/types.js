import { getPrototypeOf, hasOwn, isPrototypeOf, noop, PRIMITIVES, REGEX, TYPES, typesByCtor, typesByProto, typesByType } from './constants.js';
...
export function getTypeFromProto (obj, recurse=3) {
...
// Will recurse the whole prototype chain if recurse is -1 or Infinity
// Returns TYPES.Unknown if type not found
export function getTypeFromCtor (obj, recurse=3) {
    ...
    switch (type) {
        ...
        case TYPES.Object:
            ...
            if (type = TYPES[obj[Symbol.toStringTag]]) {
                if (type === TYPES.Uint8Array && TYPES.Buffer && TYPES.Buffer.ctor.isBuffer(obj)) {
                    return TYPES.Buffer;
                }
                return type;
            }
